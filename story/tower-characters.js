...
(function (root, factory) {
  ...
  function buildExplorer(deps) {
    ...
    group.name = 'tower-explorer-eve';
    Object.assign(group.userData, { role: 'explorer', explorerId: 'eve', characterName: '探索者・伊芙' });
    return group;
  }
  ...
  return Object.freeze({ MERCHANT_STYLES, GEAR_MOUNTS, buildMerchant, buildExplorer, buildChest, buildGear });
});
